...
//new stuff
#define LORA_TIMEOUT_MS 20000 // 5 seconds to wait for a response
long lastTxTime = 0;
...
switch(state)
  {
    ...
    case LOWPOWER:
      ...
      //this is the new code that forces a re-transmit to reconnect the modules
			if (millis() - lastTxTime > LORA_TIMEOUT_MS) {
          Serial.println("LoRa Timeout! No response received. Forcing re-transmit.");
          state = STATE_TX; // Force a re-transmit
      }
